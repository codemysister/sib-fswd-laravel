...
<div class="container">
    ...
    <div class="card mt-5">
        <div class="card-header">Kelola Slider</div>
        <div class="card-body">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <img src="{{asset($slider->img)}}" alt="" width="80px" height="80px">
                            </td>
