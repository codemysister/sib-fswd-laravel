                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarEight">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="{{url('/dashboard/produk')}}">Produk</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="{{url('/dashboard/user')}}">User</a>
                                    </li>
                                    <li class="nav-item">
            ...
            <div class="bd-example">
                <div id="carouselOne" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item bg_cover {{$slider['active'] ? 'active' : ''}}" style="background-image: url({{$slider['img']}})">
    ...
    <div class="sidebar-right">
        ...
        <div class="sidebar-content">
            <div class="sidebar-logo text-center">
                <a href="#"><img src="{{asset('assets/images/logo-alt.png')}}" alt="Logo"></a>
            </div> <!-- logo -->
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li><a href="{{url('/dashboard/user')}}">USER</a></li>
                </ul>
            </div> <!-- menu -->
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <div class="about-image text-center wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="100">
                        <img src="{{asset('assets/images/hero.jpg')}}" alt="services">
                    </div>
    ...
    <section id="portfolio" class="portfolio-area">
        <div class="container">
            ...
            <div class="row grid">
                ...
                <div class="col-lg-4 col-sm-6 {{$produk['category']}}">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        <div class="portfolio-image">
                            <img src="{{asset($produk['img'])}}" alt="">
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href="{{asset($produk['img'])}}"><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                        ...
                        <div class="portfolio-text">
                            <h4 class="portfolio-title"><a href="#">{{$produk['title']}}</a></h4>
                            <p class="text">{{$produk['caption']}}</p>
                        </div>
            ...
            <div class="row client-active">
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src="{{asset('assets/images/client_logo_01.png')}}" alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src="{{asset('assets/images/client_logo_02.png')}}" alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src="{{asset('assets/images/client_logo_03.png')}}" alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src="{{asset('assets/images/client_logo_04.png')}}" alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src="{{asset('assets/images/client_logo_05.png')}}" alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src="{{asset('assets/images/client_logo_06.png')}}" alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src="{{asset('assets/images/client_logo_07.png')}}" alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src="{{asset('assets/images/client_logo_08.png')}}" alt="Logo">
                    </div> <!-- single client -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
